...
fun AddMedicationScreen(
        ...
        when (sideEffect) {
            ...
            AddMedicationFailed -> {
                snackbarHostState.showSnackbar(
                    message = context.getString(R.string.error_medication_add_failed)
                )
            }
        }
    }
    ...
    AddMedicationScreen(
        ...
        onSaveMedicationClick = viewModel::attemptAddMedication
    )
}
...
private fun AddMedicationTopBar(
    ...
    TopAppBar(
        title = {
            Text(text = stringResource(R.string.add_medication_title))
        },
        modifier = modifier.fillMaxWidth(),
        navigationIcon = {
            IconButton(
